...
class Titanic:
    ...
    def __init__(self):
        ...
        self.train_cvs = self.load_train()  # Original train csv dataframe
        self.test_cvs = self.load_test()    # Original test csv dataframe
        self._total = self.load_clean()  # All passengers data set - train and test concatenated for processing purposes
    ...
    def load_clean(self):
        """
        This method loads and prepares the 'total' attribute, which is used for processing the features and then is
